...
class Applied(db.Model):
    ...
    applied_at = db.Column(db.DateTime, nullable=False, default=datetime)

    def __repr__(self):
        return f'<Applied applicant_id={self.applicant_id} job_id={self.job_id} applied_at={self.applied_at}>'
...
#    @property
#    def password(self):
#        raise AttributeError('password is not here')
...
#    def load_user(app_id):
#        return app if app.get_id() == app_id else None
